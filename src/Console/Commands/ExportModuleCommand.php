...
class ExportModuleCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $relativePath = str_replace(base_path('vendor/edutalk-cms/'), '', $moduleVendorPath);

        try {
            $this->files->makeDirectory(edutalk_base_path($relativePath), 755, false, true);
            $this->files->copyDirectory($moduleVendorPath, edutalk_base_path($relativePath), null);
