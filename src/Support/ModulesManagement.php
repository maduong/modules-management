<?php namespace Edutalk\Base\ModulesManagement\Support;

use \Closure;
use Illuminate\Support\Collection;
use Edutalk\Base\ModulesManagement\Events\ModuleDisabled;
use Edutalk\Base\ModulesManagement\Events\ModuleEnabled;
