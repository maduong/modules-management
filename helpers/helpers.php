...
if (!function_exists('edutalk_plugins_path')) {
    /**
     * @param string $path
     * @return string
     */
    function edutalk_plugins_path($path = '')
    {
        return base_path('plugins') . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
}

if (!function_exists('edutalk_base_path')) {
    /**
     * @param string $path
     * @return string
     */
    function edutalk_base_path($path = '')
    {
...
if (!function_exists('modules_management')) {
    /**
     * @return \Edutalk\Base\ModulesManagement\Support\ModulesManagement
     */
    function modules_management()
    {
        return \Edutalk\Base\ModulesManagement\Facades\ModulesManagementFacade::getFacadeRoot();
    }
}
